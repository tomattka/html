<%@ Page Title="" Language="C#" MasterPageFile="~/admin/mpAdmin_wide.master" AutoEventWireup="true" CodeFile="addTheory.aspx.cs" Inherits="admin_addTheory" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    <h1>Добавить страницу теории</h1>
		<div class="editForm">
			...
			<label>Раздел: <asp:DropDownList ID="lbCat" runat="server" CssClass="wideStroke" /></label>
