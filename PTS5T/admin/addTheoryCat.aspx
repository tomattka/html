<%@ Page Title="" Language="C#" MasterPageFile="~/admin/mpAdmin_wide.master" AutoEventWireup="true" CodeFile="addTheoryCat.aspx.cs" Inherits="admin_AddTheoryCat" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    <h1>Добавить раздел теории</h1>
				<div class="editForm">
