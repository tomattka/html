...
public partial class admin_addArticle : System.Web.UI.Page
{
    ...
    {
        string SQLstr = "proc_addArticle @articleTitle, @timePublished, @catTitle, @articleDesc, @articleText, @articleTags, @isPublished, @userPublished, @seoTitle, @seoDesc, @seoKeys";
        SqlConnection conn = new SqlConnection(connStr);
        conn.Open();
        SqlCommand q = new SqlCommand(SQLstr, conn);
