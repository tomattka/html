...
public partial class admin_AddArtCat : System.Web.UI.Page
{
    ...
    {
        string SQLstr = "proc_addArtCat @catTitle, @catDesc, @catText, @catTags, @seoTitle, @seoDesc, @seoKeys,	@timePublished, @psevdoName, @userPublished";
        ...
        q.ExecuteNonQuery();
        conn.Close();
        Response.Redirect("artcats.aspx?status=added");
    }
