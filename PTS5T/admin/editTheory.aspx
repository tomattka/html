<%@ Page Title="" Language="C#" MasterPageFile="~/admin/mpAdmin_wide.master" AutoEventWireup="true" CodeFile="editTheory.aspx.cs" Inherits="admin_editTheory" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    <h1>Редактировать страницу теории</h1>
    	<div class="editForm">
