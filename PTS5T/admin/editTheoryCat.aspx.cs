...
public partial class admin_editTheoryCat : System.Web.UI.Page
{
    ...
    {
        string SQLstr = "select * from theoryCategories where catId=@catId";
    ...
    protected void bSave_Click(object sender, EventArgs e)
    {
        if (checkFormats())
        {
            ...
            string SQLstr = "proc_adminUpdateTheoryCat @catId, @catTitle, @catDesc, @catText, @catTags, @seoTitle, @seoDesc, @seoKeys, @timeEdited, @psevdoName, @userEdited";
            ...
            Response.Redirect("theoryCats.aspx?status=edited");
        }
    }
